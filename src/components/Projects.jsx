    ...
    <section id="Projects" className="py-12 bg-transparent w-full">
      ...
      <div className="flex flex-wrap justify-center gap-6 px-4 w-full md:w-[90%] m-auto">
       {modal&&<div className="fixed top-0 left-0 w-screen h-screen bg-[rgba(0,0,0,0.3)] z-[100] "> 
          ...
          <div className=" w-full md:w-[90%] m-auto h-full bg-white overflow-y-scroll text-gray-800 flex justify-center items-center gap-2 flex-col  ">
              <img src={data.imageUrl} alt={data.title} className="w-full md:w-[60%] mt-3 h-[500px]  rounded object-cover" />
            <div className="p-4 w-full md:w-1/2 m-auto ">
              <div className=" flex justify-start my-2 items-center">
                <h1 className="text-2xl font-semibold  capitalize ">uses technologies:</h1>
                {data.tech.map((i) => (
